...
- use `reference_synthesized` when the value was produced by a reference for comparison
...
- if `reference_synthesized` outputs need to be promoted to `backend_native` after a backend ships
